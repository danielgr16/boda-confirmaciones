...
<head>
    ...
    <title>Invitación de Boda - Perla & Daniel</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&family=Playfair+Display:ital,wght@0,400..900;1,400..900&display=swap" rel="stylesheet"><link rel="stylesheet" href="{{ asset('css/master.css') }}">
</head>
<body class=" min-h-screen flex items-center justify-center">
    <div class="min-h-screen flex justify-center">
        <div class="w-full  shadow-xl overflow-hidden">
            ...
            {{-- Imagen principal --}}
            <div class="header-image relative w-full h-[400px]">
                <!-- Imagen base -->
                <img 
            ...
            {{-- Nombres --}}
            <div class="text-center pb-8 pt-14 px-6">
                <h1 class="text-4xl font-serif text-primary italic">
                    Perla & Daniel
                </h1>

                <p class="mt-5 text-sm font-serif text-primary leading-relaxed">
                ...
                <div class="mt-6 flex flex-col justify-center items-center gap-3">
                    <button id="play_btn" 
                        class="w-12 h-12 rounded-full flex items-center justify-center shadow-md transition btn-green">
                    ...
                    <span class="italic text-white text-xs opacity-75 flex items-center gap-2 bg-primary rounded-2xl px-3 py-1">
                ...
                <a class="btn btn-primary mt-10 block" href="{{ route('invitado.view.pass', ['novios' => $novios, 'uuid' => $uuid]) }}">¡TOCA PARA VER TU PASE!</a>
                @if($grupo['guardia'] ?? false)
                    <a class="btn btn-secondary mt-3 block" href="{{ route('invitado.checkout_list', ['novios' => $novios]) }}">Lista de Acceso (Solo guardias)</a>
                @endif
                @if($grupo['novios'] ?? false)
                    <a class="btn btn-secondary mt-3 block" href="{{ route('invitado.table', ['novios' => $novios]) }}">Confirmaciones</a>
                @endif
            </div>
            ...
            {{-- Fecha --}}
            <div class="text-center py-6 border-gray-200 font-serif text-primary mt-16">
                <p class="uppercase tracking-widest text-primary">
                    Abril
                </p>

                <div class="flex justify-center items-end gap-2 mt-2">
                    <span class="border-primary text-primary border-t-2 border-b-2 py-2 w-20">SÁBADO</span>
                    <span class="text-5xl font-serif text-primary">18</span>
                    <span class="border-primary text-primary border-t-2 border-b-2 py-2 w-20">2026</span>
                </div>
            ...
            <div class="text-center border-gray-200 z-50 px-16 py-20 pb-4">
                <script>(function(d, s, id) { var js, pjs = d.getElementsByTagName(s)[0]; if (d.getElementById(id)) return; js = d.createElement(s); js.id = id; js.src = "//www.tickcounter.com/static/js/loader.js"; pjs.parentNode.insertBefore(js, pjs); }(document, "script", "tickcounter-sdk"));</script><a data-type="countdown" data-id="9556885" class="tickcounter" style="display:block; left:0; width:100%; height:0; position:relative; padding-bottom:25%; margin:0 auto;" title="FALTAN" href="//www.tickcounter.com/">FALTAN</a>
            </div>
            ...
            <div class="text-center">
                ...
                <a class="btn btn-primary" href="{{ route('invitado.view.confirm', ['novios' => $novios, 'uuid' => $uuid]) }}">CONFIRMA AQUÍ</a>
            ...
            <div class="block info mt-7">
                ...
                <div class="lugar text-center mx-7 flex flex-col items-center">
                    ...
                    <p class="text-primary text-sm mx-9">
                ...
                <div class="vestimenta text-center mt-16">
                    <span class="block font-serif text-secondary font-bold mb-5">CÓDIGO DE VESTIMENTA</span>
                    <span class="mt-6 mb-10 font-serif text-sm px-8 text-primary">Vestimenta formal</span>
                    <div class="svg-container px-20 py-3">
                    ...
                    <span class="mt-6 mb-10 font-serif text-sm px-8 text-primary">Favor de evitar estos colores</span>
                    <div class="colors flex justify-center gap-2 mt-3">
                        <div class="color-2 bg-white h-11 w-11 border-4 border-gray-400 rounded-full"></div>
                        <div class="color-1 bg-red-500 h-11 w-11 border-4 border-red-900 rounded-full"></div>
                        <div class="color-1 bg-green-800 h-11 w-11 border-4 border-green-950 rounded-full"></div>
                    </div>
                </div>

                <div class="ninos text-center mt-16">
                    <span class="block font-serif text-secondary font-bold mb-5">NO NIÑOS</span>
                    <p class="mt-6 mb-10 font-serif text-sm px-8 text-primary">Amamos a los pequeños, pero por razones de seguridad y para que todos puedan relajarse y disfrutar, en esta ocasión el evento será solo para adultos. Agradecemos su comprensión.</p>
                </div>

                <div class="gifts text-center mt-16">
                    <div class="flex justify-center items-center opacity-50 p-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256"><path d="M216,74H174.74a46.41,46.41,0,0,0,6-4.48,27.56,27.56,0,0,0,9.22-20A30.63,30.63,0,0,0,158.5,18a27.56,27.56,0,0,0-20,9.22A57.1,57.1,0,0,0,128,45.76a57.1,57.1,0,0,0-10.48-18.53A27.56,27.56,0,0,0,97.5,18,30.63,30.63,0,0,0,66,49.51a27.56,27.56,0,0,0,9.22,20,45.74,45.74,0,0,0,6,4.48H40A14,14,0,0,0,26,88v32a14,14,0,0,0,14,14h2v66a14,14,0,0,0,14,14H200a14,14,0,0,0,14-14V134h2a14,14,0,0,0,14-14V88A14,14,0,0,0,216,74ZM135.77,63c2.25-12.12,6.29-21.75,11.69-27.85A15.68,15.68,0,0,1,158.86,30h.55A18.6,18.6,0,0,1,178,49.14a15.68,15.68,0,0,1-5.18,11.4C162.1,70,143.92,72.83,134.34,73.65,134.59,70.76,135,67.08,135.77,63ZM83.45,35.45A18.69,18.69,0,0,1,96.59,30h.55a15.68,15.68,0,0,1,11.4,5.18C118,45.9,120.83,64.08,121.65,73.66c-2.89-.25-6.57-.68-10.61-1.43C98.92,70,89.29,65.94,83.19,60.53A15.64,15.64,0,0,1,78,49.14,18.65,18.65,0,0,1,83.45,35.45ZM38,120V88a2,2,0,0,1,2-2h82v36H40A2,2,0,0,1,38,120Zm16,80V134h68v68H56A2,2,0,0,1,54,200Zm148,0a2,2,0,0,1-2,2H134V134h68Zm16-80a2,2,0,0,1-2,2H134V86h82a2,2,0,0,1,2,2Z"></path></svg>
                    </div>
                    ...
                    <div class="border-2 rounded-2xl border-gray-300 mt-6 m-5 p-4">
                        ...
                        <div class="flex justify-center gap-2 mt-3 font-sans text-sm">
                            ...
                            <div class="text-left text-primary">
                                Banorte <br>
                                1289306973 <br>
                                072028012893069735 <br>
                                4189 1400 5394 1448 <br>
                                Perla Zentella Mundo <br>
                            </div>
                        </div>
                        <span class="block font-sans text-primary mt-5">Favor de escribir en concepto: <br> 
                        <span class="italic">
                            Boda Perla y Daniel
                        </span>
                    </div>
                ...
                <div class="contacts text-center mt-16">
                    <div class="flex justify-center items-center opacity-50 p-3">
                    ...
                    <span class="block font-serif text-secondary font-bold mb-5">CONTACTOS</span>
                    <div class="font-sans text-primary">
                        <span class="font-bold">Novia</span>
                        <span>664 765 6976</span>
                    </div>
                    <div class="font-sans text-primary">
                        <span class="font-bold">Novio</span>
                        <span>664 308 1523</span>
                    </div>
                    <span class="block font-sans text-sm text-primary mt-5 mx-10">Para comunicarse el dia del evento, favor de usar el siguiente contacto</span>
                    <div class="font-sans text-primary mt-4">
                        <span class="font-bold font-sans">Dulce Zentella</span>
                        <span class="font-sans">664 724 7825</span>
                    </div>
                </div>

                <div class="gallery text-center mt-16">
                    <div class="flex justify-center items-center opacity-50 p-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256"><path d="M216,42H72A14,14,0,0,0,58,56V74H40A14,14,0,0,0,26,88V200a14,14,0,0,0,14,14H184a14,14,0,0,0,14-14V182h18a14,14,0,0,0,14-14V56A14,14,0,0,0,216,42ZM70,56a2,2,0,0,1,2-2H216a2,2,0,0,1,2,2v67.57L204.53,110.1a14,14,0,0,0-19.8,0l-21.42,21.41L117.9,86.1a14,14,0,0,0-19.8,0L70,114.2ZM186,200a2,2,0,0,1-2,2H40a2,2,0,0,1-2-2V88a2,2,0,0,1,2-2H58v82a14,14,0,0,0,14,14H186Zm30-30H72a2,2,0,0,1-2-2V131.17l36.58-36.58a2,2,0,0,1,2.83,0l49.66,49.66a6,6,0,0,0,8.49,0l25.65-25.66a2,2,0,0,1,2.83,0l22,22V168A2,2,0,0,1,216,170ZM162,84a10,10,0,1,1,10,10A10,10,0,0,1,162,84Z"></path></svg>
                    </div>
                    <span class="block font-serif text-secondary font-bold mb-5">GALERÍA DIGITAL</span>
                    <p class="mt-6 mb-10 font-serif text-sm px-8 text-primary">
                        Queremos que cada momento de nuestra boda sea compartido y recordado, 
                        asi que te invitamos a <strong>escanear o tocar este codigo</strong> para entrar, 
                    ...
                    <div class="px-14">
                        ...
                        <a href="https://photos.app.goo.gl/8p6V6xzyhuWCdoxo6" class="btn btn-secondary mt-1 ">UNIRME AL ALBÚM</a>
                    </div>
                </div>
            </div>    
        ...
        <audio id="bg_music" src="{{ asset('sound/music.ogg') }}" preload="auto" loop></audio>
    </div>
    ...
    <script>
        ...
        btn.addEventListener('click', () => {
            if (audio.paused) {
                audio.play();
                btn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#fff" viewBox="0 0 256 256"><path d="M216,48V208a16,16,0,0,1-16,16H160a16,16,0,0,1-16-16V48a16,16,0,0,1,16-16h40A16,16,0,0,1,216,48ZM96,32H56A16,16,0,0,0,40,48V208a16,16,0,0,0,16,16H96a16,16,0,0,0,16-16V48A16,16,0,0,0,96,32Z"></path></svg>`;
            } else {
                audio.pause();
                btn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#fff" viewBox="0 0 256 256"><path d="M240,128a15.74,15.74,0,0,1-7.6,13.51L88.32,229.65a16,16,0,0,1-16.2.3A15.86,15.86,0,0,1,64,216.13V39.87a15.86,15.86,0,0,1,8.12-13.82,16,16,0,0,1,16.2.3L232.4,114.49A15.74,15.74,0,0,1,240,128Z"></path></svg>`;
            }
        });
    </script>
</body>
