        ...
        <div class="w-full  shadow-xl overflow-hidden">
            ...
            <div class="text-center">
                ...
                @if($grupo['guardia'] ?? false)
                    <a class="btn btn-secondary mt-3" href="{{ route('invitado.checkout_list') }}">Lista de Acceso (Guardia)</a>
                @endif
                <a class="btn btn-primary" href="{{ route('invitado.view.pass', ['uuid' => $uuid]) }}">Ver pase</a>
